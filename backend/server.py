...
async def seed_default_templates():
    ...
    base_normal = {
        ...
        "Rins": "Rins com dimensões preservadas, contornos regulares e relação córtico-medular preservada, sem sinais de pieloectasia.",
        ...
        "Ceco": "Ceco com conteúdo gasoso/fecal. Parede sem espessamento evidente.",
        ...
        "Testículos": "Testículos com dimensões e ecotextura preservadas, sem lesões focais.",
        ...
        "Corpo Uterino": "Corpo uterino sem alterações significativas, sem conteúdo luminal evidente.",
        "Ovários": "Ovários com dimensões preservadas, com folículos de aspecto fisiológico.",
